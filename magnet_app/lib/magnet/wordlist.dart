...
//
// EFF short wordlist #1 (1296 words, max 5 letters, unique 3-char prefixes),
// https://www.eff.org/dice — CC-BY 3.0, Electronic Frontier Foundation.
// Used to generate MagNET Path C seed-phrase credentials (~10.34 bits/word;
// 13 words ~ 134 bits). The firmware HKDFs the raw phrase (SPACE-separated,
// design proposal §11.1.2) and enforces no list, so this choice is purely
// about generation quality and memorability.

/// 1296 short, distinct, memorable words.
const List<String> effShortWordlist = <String>[
