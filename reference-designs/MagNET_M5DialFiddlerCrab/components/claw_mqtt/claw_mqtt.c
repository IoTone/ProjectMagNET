...
static const char *TAG = "claw_mqtt";
...
static claw_mqtt_msg_cb_t  s_msg_cb  = NULL;
static claw_mqtt_conn_cb_t s_conn_cb = NULL;
static void *s_ctx = NULL;

// ---------------------------------------------------------------------------
// Parse pipe-delimited message into claw_mqtt_msg_t.
