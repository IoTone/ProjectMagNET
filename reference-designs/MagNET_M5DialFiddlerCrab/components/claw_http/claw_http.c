...
static const char *TAG = "claw_http";

static httpd_handle_t s_server = NULL;

static claw_http_notify_cb_t s_notify_cb = NULL;
static claw_http_status_cb_t s_status_cb = NULL;
static void *s_ctx = NULL;

// ---------------------------------------------------------------------------
// /notify — parse query params into claw_mqtt_msg_t and invoke callback
// ---------------------------------------------------------------------------
