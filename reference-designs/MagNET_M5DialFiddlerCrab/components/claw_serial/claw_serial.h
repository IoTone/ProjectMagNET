/**
 * claw_serial.h — Platform-abstracted serial I/O for Claw projects
 *
 ...
 */
#ifndef CLAW_SERIAL_H
#define CLAW_SERIAL_H
 ...
 * Must be called once before any other claw_serial function.
 */
